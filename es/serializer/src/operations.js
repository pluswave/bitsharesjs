...
var uint8 = types.uint8,
    ...
    indexed_optional = types.indexed_optional,
...
export var call_order_update_options = new Serializer(
...
export var asset_update_issuer = new Serializer("asset_update_issuer", {
    fee: asset,
    issuer: protocol_id_type("account"),
    asset_to_update: protocol_id_type("asset"),
