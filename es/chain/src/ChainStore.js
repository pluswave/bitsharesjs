...
var ChainStore = (function() {
                ...
                if (ChainValidation.is_object_id(obj)) {
                    ...
                    switch (objectType) {
                        case "limit_order":
                            ...
                            if (old_obj) {
                                var account = _this2.objects_by_id.get(
                                    old_obj.get("seller")
                                );
                        ...
                        case "call_order":
                            ...
                            if (old_obj) {
                                var _account = _this2.objects_by_id.get(
                                    old_obj.get("borrower")
                                );
                                if (_account && _account.has("call_orders")) {
                                    var call_orders = _account.get(
                                        "call_orders"
                                    );
        ...
        if (this.get_account_refs_of_keys_calls.has(key))
            ...
            Apis.instance()
                ...
                .then(function(vec_account_id) {
                    ...
                    _this5.account_ids_by_key = _this5.account_ids_by_key.set(
                        key,
                        refs
                    );
                ...
                .catch(function(err) {
                    ...
                    _this5.account_ids_by_key = _this5.account_ids_by_key.delete(
                        key
                    );
        ...
        if (this.get_account_refs_of_accounts_calls.has(account_id))
            ...
            Apis.instance()
                ...
                .then(function(vec_account_id) {
                    ...
                    _this6.account_ids_by_account = _this6.account_ids_by_account.set(
                        account_id,
                        refs
                    );
                ...
                .catch(function(err) {
                    ...
                    _this6.account_ids_by_account = _this6.account_ids_by_account.delete(
                        account_id
                    );
                    _this6.get_account_refs_of_accounts_calls.delete(
                        account_id
                    );
                });
            return undefined;
            ...
            Apis.instance()
                ...
                .then(
                    function(balance_objects) {
                        ...
                        _this7.balance_objects_by_address.set(
                            address,
                            Immutable.Set(set)
                        );
            ...
            Apis.instance()
                ...
                .then(function(optional_witness_object) {
                    if (optional_witness_object) {
                        ...
                        _this10.witness_by_account_id = _this10.witness_by_account_id.set(
                            optional_witness_object.witness_account,
                            optional_witness_object.id
                        );
                        var witness_object = _this10._updateObject(
            ...
            Apis.instance()
                ...
                .then(function(optional_committee_object) {
                    if (optional_committee_object) {
                        ...
                        _this11.committee_by_account_id = _this11.committee_by_account_id.set(
                            optional_committee_object.committee_member_account,
                            optional_committee_object.id
                        );
                        var committee_object = _this11._updateObject(
        ...
        if (
            ...
            Apis.instance()
                ...
                .then(function(results) {
                    ...
                    _this12.get_full_accounts_subscriptions.set(
                ...
                .catch(function(error) {
                    console.log("Error: ", error);
                    if (ChainValidation.is_object_id(name_or_id))
                        _this12.objects_by_id.delete(name_or_id);
                    else _this12.accounts_by_name.delete(name_or_id);
                });
        }
        return undefined;
    };
        ...
        pending_request.promise = new Promise(function(resolve, reject) {
            Apis.instance()
                ...
                .then(function(operations) {
                    ...
                    var pending_request = _this13.account_history_requests.get(
                        account_id
                    );
        ...
        */
        ...
        switch (objectType) {
            ...
            case "account_statistics":
                try {
                    var prior_most_recent_op = prior.get(
                        "most_recent_op",
                        "2.9.0"
                    );
    ...
    ChainStore.prototype.getObjectsByVoteIds = function getObjectsByVoteIds(
        ...
        for (var i = 0; i < vote_ids.length; ++i) {
            ...
            if (_obj) result.push(this.getObject(_obj));
            else {
                result.push(null);
