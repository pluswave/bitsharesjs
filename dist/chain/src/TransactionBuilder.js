    ...
    */
    ...
    TransactionBuilder.prototype.set_required_fees = function set_required_fees(asset_id) {
        ...
        return Promise.all(promises).then(function (results) {
            ...
            var dynamicPromise = asset_id !== "1.3.0" && asset ? _bitsharesjsWs.Apis.instance().db_api().exec("get_objects", [[asset.dynamic_asset_data_id]]) : new Promise(function (resolve, reject) {
                resolve();
            });
